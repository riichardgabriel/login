...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    echo isset($id_alterar) ? 'sim' : 'falso';
...
<body class="d-flex align-items-center py-4 bg-body-tertiary cadastro">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="auxcadastro.php" method="POST">
            ...
            <input type="text" name="id_para_alterar" value="<?=isset($id_alterar) ? $dadosUsuario['id']: '' ?>">
            ...
            <div class="form-floating my-2">
                <input value="<?=isset($id_alterar) ? $dadosUsuario['usuario'] : '' ?>" class="form-control" id="usuario" name="usuario" placeholder="Usuario">
